    ...
    <main class="contenedor seccion">
        ...
        <table class="propiedades">
            ...
            <tbody> <!-- Mostrar los resultados -->
                ...
                <tr>
                    <td class="text-dark-mode"><?php echo $propiedad['id']; ?></td>
                    <td class="text-dark-mode"><?php echo $propiedad['titulo']; ?></td>
                    <td><img src="/imagenes/<?php echo $propiedad['imagen']; ?>" class="imagen-tabla"></td>
                    <td class="text-dark-mode"><?php echo $propiedad['precio']; ?></td>
                    <td>
